            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="/logout.do"> <i class="ace-icon fa fa-power-off"></i>
                                注销
                            </a>
                        </li>
                    </ul>
...
<div class="main-container" id="main-container">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/role/page2.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            角色管理
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a class="popstyle" href="/config/page.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            全局配置管理
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/admin/schedule/page.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            定时任务管理
                        </a>
                        <b class="arrow"></b>
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="/sys/user/page.do" width="99%" style="min-height: 768px;"></iframe>
    </div>
    <!-- /.main-content -->
